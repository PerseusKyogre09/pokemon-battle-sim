const Items = {
    abilityshield: {
        ...
        onSetAbility(ability, target, source, effect) {
            ...
            this.add('-block', target, 'item Shield');
            return null;
        },
    ...
    boosterenergy: {
        ...
        onStart(pokemon) {
            ...
            ((this.effect).onUpdate) => void).call(this, pokemon);
        },
        onUpdate(pokemon) {
    ...
    clearamulet: {
        ...
        onTryBoost(boost, target, source, effect) {
            ...
            if (showMsg && !(effect).secondaries && effect.id !== 'octolock') {
                this.add('-fail', target, 'unboost', '[from] item Amulet', `[of] ${target}`);
            }
        },
        num: 1882,
        gen: 9,
    ...
    custapberry: {
        ...
        onFractionalPriority(priority, pokemon) {
            if (
                ...
                if (pokemon.eatItem()) {
                    this.add('-activate', pokemon, 'item Berry', '[consumed]');
                    return 0.1;
                }
            }
        },
    ...
    focusband: {
        ...
        onDamage(damage, target, source, effect) {
            if (this.randomChance(1, 10) && damage >= target.hp && effect && effect.effectType === 'Move') {
                this.add("-activate", target, "item Band");
                return target.hp - 1;
            }
        },
        num: 230,
    ...
    greninjite: {
        ...
        itemUser: ["Greninja"],
        onTakeItem(item, source) {
            // TODO out if this works on Greninja-Bond
            return !item.megaStone?.[source.baseSpecies.baseSpecies];
        },
        num: 2577,
        gen: 9,
    ...
    ironball: {
        ...
        // airborneness negation implemented in sim/pokemon.js#isGrounded
        onModifySpe(spe) {
            return this.chainModify(0.5);
        },
        num: 278,
    ...
    leppaberry: {
        ...
        onEat(pokemon) {
            ...
            this.add('-activate', pokemon, 'item Berry', moveSlot.move, '[consumed]');
        },
        num: 154,
        gen: 3,
    },
    ...
    loadeddice: {
        ...
        // partially implemented in sim/battle-actions.ts#hitStepMoveHitLoop
        onModifyMove(move) {
                    ...
                    if (pokemon.volatiles[firstCondition]) {
                        for (const secondCondition of conditions) {
                            ...
                            if (firstCondition === 'attract' && secondCondition === 'attract') {
                                this.add('-end', pokemon, 'move', '[from] item Herb');
                            }
                        }
                        return;
                    }
    ...
    quickclaw: {
        ...
        onFractionalPriority(priority, pokemon, target, move) {
            ...
            if (priority <= 0 && this.randomChance(1, 5)) {
                this.add('-activate', pokemon, 'item Claw');
                return 0.1;
            }
        },
        name: "Quick Claw",
    ...
    safetygoggles: {
        ...
        onTryHit(pokemon, source, move) {
            if (move.flags['powder'] && pokemon !== source && this.dex.getImmunity('powder', pokemon)) {
                this.add('-activate', pokemon, 'item Goggles', move.name);
                return null;
            }
        },
        num: 650,
    ...
    whiteherb: {
        ...
        onAnySwitchIn() {
            ((this.effect).onStart) => void).call(this, this.effectState.target);
        },
        onAnyAfterMega() {
            ((this.effect).onStart) => void).call(this, this.effectState.target);
        },
        ...
        onResidualOrder: 29,
        onResidual(pokemon) {
            ((this.effect).onStart) => void).call(this, pokemon);
        },
        onUse(pokemon) {
    ...
    mysteryberry: {
        ...
        onEat(pokemon) {
            ...
            this.add('-activate', pokemon, 'item Berry', moveSlot.move);
        },
        num: 154,
        gen: 2,
        isNonstandard: "Past",
