...
# Mapping of short/base names to PokeAPI-specific names
POKEAPI_NAME_MAP = {
...
MEGA_STONES = {
    ...
    "tatsugirinite": "tatsugiri-stretchy-mega",
...
def get_mandatory_item(pokemon_name: str) -> Optional[str]:
    ...
    return ITEM_LOCKED_FORMS.get(normalized)
